...
public class SignupServlet extends HttpServlet {
    ...
    try{  
      ...
      PreparedStatement pst =(PreparedStatement) conn.prepareStatement("insert into artist (a_id, email, a_name, state, city, pincode, phone,g_id,pwd ) values(?,?,?,?,?,?,?,?,?)");//try2 is the name of the table  
