...
//conn = DriverManager.getConnection(url+dbName,"root", "pwd");
if(request.getParameter("Upload")!= null){
  ...
  conn = DriverManager.getConnection(url+dbName,"root", "pwd");
  PreparedStatement pst =(PreparedStatement) conn.prepareStatement("insert into painting(title,year,url,type,email) values(?,?,?,?,?)");//try2 is the name of the table  
